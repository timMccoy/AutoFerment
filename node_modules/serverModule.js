...
function onRequest(request, response)
{
	...
	else if(request.method == 'GET' && request.url == '/creatorPanelJs')
	{
		response.writeHead(200, {"Context-Type": "text/js"});
		fs.createReadStream("../javascript/creatorPanel.js").pipe(response);
	}
...
http.createServer(onRequest).listen(3000, '192.168.1.74');
